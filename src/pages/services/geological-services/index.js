    ...
    <Layout>
      <div className='grid gap-32 bg-whiteSmoke py-20 md:gap-60 md:py-40'>
        <div className='container mx-auto px-4 text-center md:px-8'>
          ...
          <div className='my-24 grid justify-center gap-8 sm:grid-cols-2 lg:mx-32 lg:grid-cols-3'>
                    ...
                    <AnimatePresence>
                      {open && (
                        ...
                        >
                          ...
                          <p className='text-2xl font-bold'>✔ Operating Procedures, Health and Safety Certification</p>
                    ...
                    <AnimatePresence>
                      {open && (
                        ...
                        >
                          ...
                          <p className='text-2xl font-bold'>➜ Data collection procedure review with recommendations</p>
        ...
        <div className='container mx-auto grid items-center gap-16 px-4 md:px-8 lg:grid-cols-2'>
          <img className='w-full rounded-2xl' src={OverviewImage} alt='Overview' />
          ...
          <div className='flex flex-col'>
            ...
            <p className='text-xl font-bold leading-normal text-gray'>
...
export function Head() {
  return (
    <>
      ...
      <meta
        name='description'
        content='We have the equipment to get the job done. We provide the full suite of servivces needed on-site for an active exploration program, and we help you analyze the data so you can leverage the insights.'
      />
    </>
  );
}
