    ...
    <Layout>
      <div className='grid gap-32 bg-whiteSmoke py-20 md:gap-60 md:py-40'>
        ...
        <div className='mx-auto w-full max-w-[1410px] rounded-[2rem] bg-dark px-8 py-16'>
          <div className='container mx-auto grid items-center gap-8 lg:grid-cols-4-6'>
            <div className='flex flex-col'>
              <h4 className='mb-4 text-2xl font-bold text-primaryLight'>Sample Preparation</h4>
        ...
        <div className='container mx-auto items-center gap-16 px-4 md:px-8'>
          ...
          <h4 className='mb-4 text-xl font-bold leading-normal text-grayLight'>
            Lead Collection Fire Assay with AAS/Gravimetric Finish
          </h4>
          <h5 className='mb-2 text-xl font-bold leading-normal text-grayLight'>
          ...
          <h3 className='my-12 text-center text-3xl font-bold leading-normal text-black'>FIRE ASSAY-AAS FINISH</h3>

          <table className='block w-full rounded-2xl bg-white p-4 text-center md:p-8'>
            <thead className='block'>
              <tr className='grid grid-cols-5 border-b-4 border-grayLigher text-xs'>
                <th className='py-4'>Code</th>
                <th className='border-l border-grayLight py-4'>Analyte</th>
                <th className='border-l border-grayLight py-4'>Detection Limit (µg/g)</th>
                <th className='border-l border-grayLight py-4'>Upper Limit (µg/g)</th>
                <th className='border-l border-grayLight py-4'>Sample Weight (g)</th>
              </tr>
            </thead>
            <tbody className='block'>
              <tr className='grid grid-cols-5 text-xs'>
                <td className='border-grayLight py-4'>FA301-AA</td>
                <td className='border-l border-grayLight py-4'>Au</td>
                <td className='border-l border-grayLight py-4'>0.005</td>
                <td className='border-l border-grayLight py-4'>10</td>
                <td className='border-l border-grayLight py-4'>30</td>
              </tr>
            </tbody>
          </table>

          <h3 className='my-12 text-center text-3xl font-bold leading-normal text-black'>
          ...
          <table className='block w-full rounded-2xl bg-white p-4 text-center md:p-8'>
            ...
            <tbody className='block'>
              <tr className='grid grid-cols-5 border-b-4 border-grayLigher text-xs'>
                <td className='border-grayLight py-4'>FA301-GR</td>
                <td className='border-l border-grayLight py-4'>Au</td>
                <td className='border-l border-grayLight py-4'>0.035</td>
                <td className='border-l border-grayLight py-4'>-</td>
                <td className='border-l border-grayLight py-4'>30</td>
              </tr>
              <tr className='grid grid-cols-5 pb-8 text-xs'>
                <td className='border-grayLight py-4'>FA303-GR</td>
                <td className='border-l border-grayLight py-4'>Ag</td>
                <td className='border-l border-grayLight py-4'>3.50</td>
                <td className='border-l border-grayLight py-4'>-</td>
                <td className='border-l border-grayLight py-4'>30</td>
              </tr>
            </tbody>
